...
{
    public partial class LoggingConfiguration : MetroForm
    {
        ...
        private void LoggingConfiguration_Load(object sender, EventArgs e)
        {
            try
            {
                // set topmost
                ...
                // set title
                Text = $"Logging   |   {Variables.ApplicationName}";
            ...
            {
                Log.Fatal(ex, "[CONFIGURATION-LOGGING] Error loading settings: {err}", ex.Message);
        ...
        private void BtnStore_Click(object sender, EventArgs e)
        {
            ...
            {
                Log.Fatal(ex, "[CONFIGURATION-LOGGING] Error saving settings: {err}", ex.Message);
        ...
        private void LoggingConfiguration_KeyUp(object sender, KeyEventArgs e)
        {
